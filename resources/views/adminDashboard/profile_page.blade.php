                ...
                <div class="col-md-12 col-xl-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div>
                                <a class="btn btn-primary btn-md" href="{{ route('admin.profile.settings') }}"><i
                                        class="align-left mr-1 mb-1" data-feather="edit-2"></i>
                                    Edit Profile</a>
                            </div>
                        </div>
                        <hr class="my-0" />
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li class="mb-1"><span data-feather="briefcase" class="feather-sm mr-1"></span> Works at <a
                                        href="#">GitHub</a></li>
                ...
                {{-- <div class="col-md-8 col-xl-9">
                    <div class="card">
                        ...
                        <div class="card-body h-100">
                            ...
                            <hr />
                            <div class="media">
                                <img src="img/avatars/avatar-2.jpg" width="36" height="36" class="rounded-circle mr-2"
                                    alt="Carl Jenkins">
                                <div class="media-body">
